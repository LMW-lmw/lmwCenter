<template>
  <div id="person-center">
    <div class="top">
      <img src="~assets/img/personCenter/icon_livetime.png"
           alt="">
      ...
      <div class="info-right">
        <div class="right-top">
          <div class="exercise">
            <ul>
              <li>
                <img src="~assets/img/personCenter/icon_practice.png"
                     alt="">
          ...
          <div class="entrance">
            ...
            <div class="begin-exercise">
              <div class="go"
                   @click="changeRouter('/doExercise')">
                <img src="~assets/img/personCenter/icon_enter.png"
                     alt="">
                <span>进入练习</span>
              </div>
            </div>
        ...
        <div class="my-order">
          ...
          <div class="order-buttom">
            <div class="orders"
                 @click="changeRouter('/myOrder')">
              <img src="~assets/img/personCenter/icon_paid.png"
                   alt="">
              <div>已付款订单</div>
            </div>
            <div class="all-class"
                 @click="changeRouter('/couresCenter')">
              <img src="~assets/img/personCenter/icon_all.png"
                   alt="">
              <div>全部课程</div>
            </div>
          </div>
