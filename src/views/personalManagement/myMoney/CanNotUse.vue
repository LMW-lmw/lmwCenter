<template>
  <div>
    <div class="info">
      <div class="coupon" v-for="item in no">
        <div class="money">
          <div>
          <span>¥</span>
...
<style scoped>
  ...
  .coupon{
    ...
    width: 350px;
    height: 96px;
    background-image: url("../../../assets/img/backgroundImg/Expired.png") !important;
  ...
  .money{
    ...
    background-image: url("../../../assets/img/backgroundImg/nocoupon.png") !important;
    background-repeat:no-repeat;
    font-size: 16px;
